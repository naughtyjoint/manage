...
class coderDBConf
{
    ...
    public static $col_mycard = array('id'=>'id','member_id'=>'member_id','FacTradeSeq'=>'FacTradeSeq','product_id'=>'product_id','Amount'=>'Amount','Currency'=>'Currency','Created_date'=>'Created_date','PayResult'=>'PayResult','ReturnCode'=>'ReturnCode','Pay_time'=>'Pay_time','Check_time'=>'Check_time','agent_id'=>'agent_id','Redeposit'=>'Redeposit');
