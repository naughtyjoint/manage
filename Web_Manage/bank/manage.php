                        ...
                        <div class="box-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group ">
                                        <label class="col-sm-3 col-lg-3 control-label">
                                            <?php echo $fhelp->drawLabel($colname['money_max']) ?> </label>
                                        <div class="col-sm-3 controls">
                                            <?php echo $fhelp->drawForm($colname['money_max']) ?>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="col-sm-3 col-lg-3 control-label">
                                            <?php echo $fhelp->drawLabel($colname['money_min']) ?> </label>
                                        <div class="col-sm-3 controls">
                                            <?php echo $fhelp->drawForm($colname['money_min']) ?>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="col-sm-3 col-lg-3 control-label">
