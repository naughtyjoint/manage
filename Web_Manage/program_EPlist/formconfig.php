...
$fobj[$colname_ep['start_time']]  =array("type"=>"text","name"=>'開始時間',                       "column"=>$colname_ep['start_time'],       'placeholder'=>'請點選開始時間', 'autocomplete'=>'off',"validate"=>array('required' => 'yes'));
$fobj[$colname_ep['end_time']]  =array("type"=>"text","name"=>'結束時間',                       "column"=>$colname_ep['end_time'],       'placeholder'=>'請點選結束時間', 'autocomplete'=>'off',"validate"=>array('required' => 'yes'));
