...
$obj[] = array('type' => 'dategroup', 'column' => 'dategroup', 'sql' => true,'table'=>'t', 'ary' => array(array('column' => $colname['Created_date'], 'name' => '申請時間'), array('column' => $colname['Check_time'], 'name' => '審核時間')));
$filterhelp->Bind($obj);
