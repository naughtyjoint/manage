...
$fobj[$colname["is_pay"]]=array("type"=>"radio","name"=>"狀態","column"=>$colname["is_pay"],'ary'=>coderHelp::makeAryKeyToAryElement($langary_transfers,'key','name'),'mode'=>'no',"placeholder"=>"請設定狀態","equal"=>"=");
