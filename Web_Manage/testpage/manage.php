                        ...
                        <div class="box-content">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group ">
                                        <label class="col-sm-3 col-lg-3 control-label">
                                            <?php echo $fhelp->drawLabel($colname['age']) ?> </label>
                                        <div class="col-sm-5 controls">
                                            <?php echo $fhelp->drawForm($colname['age']) ?>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="col-sm-3 col-lg-3 control-label">
                                            <?php echo $fhelp->drawLabel($colname['weight']) ?> </label>
                                        <div class="col-sm-5 controls">
                                            <?php echo $fhelp->drawForm($colname['weight']) ?>
                                        </div>
                                    </div>
