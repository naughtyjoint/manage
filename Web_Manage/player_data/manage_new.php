...
try {
    ...
    if ($id != "") {
        ...
        $agen_id = $adminuser["id"];
        $fhelp -> setAttr($colname['password'], 'validate', array('required'=>'yes', 'maxlength'=>'20', 'minlength'=>'6'));
        $fhelp -> setAttr('repassword', 'validate', array('required'=>'yes', 'maxlength'=>'20', 'minlength'=>'6', 'equalto'=>'#'.$colname['password'], 'data-msg-equalto'=>'請重新輸入密碼'));
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-5 control-label" style="text-align: left;">
                                            <?php echo class_admin::getName($agen_id); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-5 control-label" style="text-align: left;">
                                            <?php echo $fhelp->drawForm($colname['openid']); ?>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="col-sm-3 col-lg-3 control-label">
                                            <?php echo $fhelp->drawLabel($colname['nickname']) ?> </label>
                                        <div class="col-sm-5 control-label" style="text-align: left;">
                                            <?php echo $fhelp->drawForm($colname['nickname']); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-3 control-label">
                                            <?php echo $fhelp->drawLabel('sex') ?>
                                        </label>
                                        <div class="col-sm-5 control-label" style="text-align: left;">
                                            <?php echo $fhelp->drawForm('sex') ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-3 control-label">
                                            <?php echo $fhelp->drawLabel('province') ?>
                                        </label>
                                        <div class="col-sm-5 control-label" style="text-align: left;">
                                            <?php echo $fhelp->drawForm('province') ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-3 control-label">
                                            <?php echo $fhelp->drawLabel('city') ?>
                                        </label>
                                        <div class="col-sm-5 control-label" style="text-align: left;">
                                            <?php echo $fhelp->drawForm('city') ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-3 control-label">
                                            <?php echo $fhelp->drawLabel('country') ?>
                                        </label>
                                        <div class="col-sm-5 control-label" style="text-align: left;">
                                            <?php echo $fhelp->drawForm('country') ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-5 control-label" style="text-align: left;">
                                        <?php echo $fhelp->drawForm($colname['carduser']) ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-5 control-label" style="text-align: left;">
                                        <?php echo $fhelp->drawForm($colname['card']) ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-5 control-label" style="text-align: left;">
                                        <?php echo $fhelp->drawForm($colname['cardname']) ?>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="col-sm-3 col-lg-3 control-label">
