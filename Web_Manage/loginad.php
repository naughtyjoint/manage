        ...
        <div id="loginform" class="login-wrapper" myac="1">
            ...
            <form id="forgot" style="display:none">
                ...
                <div id="formforgot">
                    <div class="form-group">
                        <div class="controls">
                            <input type="text"  id="forgotme_email" name="forgotme_email" placeholder="<?php echo $langary_login['forgot3'];?>" class="form-control"  autocomplete="off" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="controls">
                            <button type="button" class="btn btn-primary form-control" id="sendauthemail"><?php echo $langary_login['forgot4'];?></button>
                        </div>
                    </div>
                    <hr/>
                    <p class="clearfix">
