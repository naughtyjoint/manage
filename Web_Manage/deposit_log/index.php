...
$col[] = array('column' => $colname_m['member_id'], 'name' => '會員ID', 'order' => true, 'width' => '60');
$col[] = array('column' => $colname_m['name'], 'name' => '會員名稱', 'order' => true, 'width' => '60');
$col[] = array('column' => $colname_g['name'], 'name' => '平台名稱', 'order' => true, 'width' => '60');
        ...
        $('#table1').coderlisthelp({
            debug: true, callback: function (obj, rows) {
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    $tr.append('<td>' + row["<?php echo $colname_m['member_id'];?>"] + '</td>');
