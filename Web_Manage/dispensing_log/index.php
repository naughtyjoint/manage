...
$col = array();
$col[] = array('column' => $colname['dispensing_id'], 'name' => '出款ID', 'order' => true, 'width' => '60');
$col[] = array('column' => $colname['member_id'], 'name' => '會員ID', 'order' => true, 'width' => '60');
...
$col[] = array('column' => $colname['is_pay'], 'name' => '修改狀態', 'order' => false,'width'=>'120');
        ...
        $('#table1').coderlisthelp({
            debug: true, callback: function (obj, rows) {
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    $tr.attr("title", row["<?php echo $colname['member_id'];?>"]);
                    $tr.append('<td>' + row["<?php echo $colname['dispensing_id'];?>"] + '</td>');
