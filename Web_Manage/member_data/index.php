...
$col[] = array('column' => $colname['member_id'], 'name' => '會員ID ', 'order' => false, 'width' => '250');
$col[] = array('column' => $colname['name'], 'name' => '會員名稱 ', 'order' => false, 'width' => '250');
$col[] = array('column' => $colname['platform_name'], 'name' => '平台名稱 ', 'order' => false);
        ...
        $('#table1').coderlisthelp({
            debug: true, callback: function (obj, rows) {
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    $tr.append('<td>' + row["<?php echo $colname['platform_name'];?>"] + '</td>');
