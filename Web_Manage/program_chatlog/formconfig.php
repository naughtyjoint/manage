...
$fobj[$colname_cl['sender']]  =array("type"=>"text","name"=>$langary_Web_Manage_all['sender'],                       "column"=>$colname_cl['sender'],       'placeholder'=>'請輸入發送者', 'autocomplete'=>'off', 'equal'=>'=',"validate"=>array('required' => 'yes'));
$fobj[$colname_cl['chatlog']]  =array("type"=>"text","name"=>$langary_Web_Manage_all['chatlog'],                       "column"=>$colname_cl['chatlog'],       'placeholder'=>'請輸入聊天紀錄', 'autocomplete'=>'off', 'equal'=>'=',"validate"=>array('required' => 'yes'));
