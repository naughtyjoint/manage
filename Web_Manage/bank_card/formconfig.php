...
$fobj[$colname['bank_name']] = array(
    'type' => 'select', 'name' => $langary_Web_Manage_all['bank'], 'column' => $colname['bank_name'], 'ary' => $bank_array, 'validate' => array(
        'required' => 'yes'
    )
);
$fobj[$colname["bank_no"]]=array("type"=>"text","name"=>"後五碼","column"=>$colname["bank_no"],'placeholder'=>'請輸入卡號後五碼',"validate"=>array('required' => 'yes','maxlength' => '10'));
