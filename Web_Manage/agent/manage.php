...
try {
    ...
    if ($id != "") {
        ...
        /* ## coder [bindData] --> ## */
        $manageinfo='  '.$langary_manage['admin'].' '.$row[$colname['manager']].' | '.$langary_manage['createtime'].' '.$row[$colname['created_time']].' | '.$langary_manage['updatetime'].' '.$row[$colname['updated_time']];
