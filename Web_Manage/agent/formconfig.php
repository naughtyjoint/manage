...
$fobj[$colname["id"]]=array("type"=>"hidden","name"=>"ID","column"=>$colname["id"],"sql"=>false);
    $fobj[$colname['agent_id']]=array('type'=>'text','name'=>'代理ID','column'=>$colname['agent_id'],'autocomplete'=>'off','placeholder'=>'請輸入代理ID', array('required' => 'yes'));
    $fobj[$colname['name']]     =array('type'=>'text','name'=>'代理名稱','column'=>$colname['name'],'autocomplete'=>'off','placeholder'=>'請輸入代理名稱','icon'=>'<i class="icon-user"></i>', array('required' => 'yes'));
