...
$fobj[$colname["thumbnail"]]   =array("type"=>"file","name"=>$langary_Web_Manage_all['thumbnail'],  "column"=>$colname["thumbnail"],    'placeholder'=>'請輸入'.$langary_Web_Manage_all['thumbnail'],'autocomplete'=>'off',"validate"=>array('required' => 'yes'));
