...
$col[] = array('column' => $colname['url'],         'name' => $langary_Web_Manage_all['url'],        'order' =>false, 'width' => '80');
$col[] = array('column' => $colname['tag'],         'name' => $langary_Web_Manage_all['tag'],        'order' =>false, 'width' => '120');
$col[] = array('column' => $colname['createtime'],  'name' => $langary_Web_Manage_all['create_time'],'order' => true, 'width' => '200');
